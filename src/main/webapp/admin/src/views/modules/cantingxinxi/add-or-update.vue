  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="餐厅名称" prop="cantingmingcheng">
              <el-input v-model="ruleForm.cantingmingcheng" 
                placeholder="餐厅名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="餐厅类型" prop="cantingleixing">
          <el-input v-model="ruleForm.cantingleixing" 
              placeholder="餐厅类型" clearable  :readonly="ro.cantingleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="餐厅类型" prop="cantingleixing">
              <el-input v-model="ruleForm.cantingleixing" 
                placeholder="餐厅类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.cantingtupian" label="餐厅图片" prop="cantingtupian">
          <file-upload
          tip="点击上传餐厅图片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.cantingtupian" label="餐厅图片" prop="cantingtupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.cantingtupian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="配送时间" prop="peisongshijian">
              <el-input v-model="ruleForm.peisongshijian" 
                placeholder="配送时间" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="配送服务" prop="peisongfuwu">
          <el-input v-model="ruleForm.peisongfuwu" 
              placeholder="配送服务" clearable  :readonly="ro.peisongfuwu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="配送服务" prop="peisongfuwu">
              <el-input v-model="ruleForm.peisongfuwu" 
                placeholder="配送服务" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="餐厅地址" prop="cantingdizhi">
              <el-input v-model="ruleForm.cantingdizhi" 
                placeholder="餐厅地址" readonly></el-input>
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="餐厅介绍" prop="cantingjieshao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.cantingjieshao" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.cantingjieshao" label="餐厅介绍" prop="cantingjieshao">
                    <span v-html="ruleForm.cantingjieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.peisongshijian = true;
            continue;
	            	            ...
	            	            if(o=='peisongfuwu'){
            this.ruleForm.peisongfuwu = obj[o];
	    this.ro.peisongfuwu = true;
            continue;
          }
	            	            if(o=='lianxidianhua'){
	    ...
	    this.ro.cantingdizhi = true;
            continue;
	            	            ...
	            	            if(o=='cantingjieshao'){
            this.ruleForm.cantingjieshao = obj[o];
	    this.ro.cantingjieshao = true;
            continue;
          }
	                    }
                                                                                                                                              }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `cantingxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.cantingxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
