...
layui.define(['jquery', 'layer'], function(exports) { //提示：模块也可以依赖其它模块，如：layui.define('layer', callback);
	...
	var jquery = layui.jquery,
		layer = layui.layer,
		        baseurl = "https://ot-ssm98yok-api-273280-7-1369167244.sh.run.tcloudbase.com/ssm98yok/";
        	var http = {
		        domain : "https://ot-ssm98yok-api-273280-7-1369167244.sh.run.tcloudbase.com/ssm98yok/",
        		baseurl: baseurl,
		/**
		 * 获取传递参数值(修改支持中文)
		 */
